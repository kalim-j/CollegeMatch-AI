...
,
...

  {
    ...
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA","Executive MBA","PGPEx"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 95000
...

  {
    ...
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA","Executive MBA","PGP-Finance","PGP-LSM"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 85000
...

  {
    ...
    level: "Both",
    naac_grade: "A++",
    courses: ["IPM (Integrated MBA)","MBA","Executive MBA"],
    fees_structure: {
      ug_annual: 500000,
      ug_total: 1500000,
      hostel_annual: 80000
...

  {
    ...
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA","MBA Agri-Business","Executive MBA"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 90000
...

  {
    ...
    level: "PG",
    naac_grade: "A",
    courses: ["MBA","MBA Human Resources","PhD in Management"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 75000
  ...
  {
    id: 10299,
    name: "Indian Institute of Management (IIM) Udaipur",
    location: "Balicha",
    district: "Udaipur",
    state: "Rajasthan",
    type: "Government",
    level: "PG",
    naac_grade: "A",
    courses: ["MBA","MBA Global Supply Chain","MBA Digital Enterprise"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 80000
  ...
  {
    id: 10300,
    name: "Indian Institute of Management (IIM) Amritsar",
    ...
    level: "PG",
    naac_grade: "A",
    courses: ["MBA","MBA Business Analytics","MBA HR"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 70000
    ...
    cutoff_sc: 80,
    cutoff_st: 75,
    avg_package_lpa: 16.51,
    max_package_lpa: 36.25,
    seats: 240,
    nirf_rank: 51,
...

  {
    ...
    location: "Jagti Campus",
    district: "Jammu and Kashmir",
    state: "Jammu and Kashmir",
    type: "Government",
    level: "Both",
    naac_grade: "A",
    courses: ["Integrated Programme in Management (IPM)","MBA","Executive MBA"],
    fees_structure: {
      ug_annual: 485000,
      ug_total: 1455000,
      hostel_annual: 75000
...

  {
    ...
    location: "Kundeshwari",
    district: "Dehradun",
    state: "Uttarakhand",
    type: "Government",
    level: "PG",
    naac_grade: "A",
    courses: ["MBA","MBA Analytics","Executive MBA"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 70000
...

  {
    ...
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA","MS by Research","PhD"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 35000
    ...
    cutoff_sc: 85,
    cutoff_st: 80,
    avg_package_lpa: 20.19,
    max_package_lpa: 30.6,
    seats: 80,
    nirf_rank: 15,
...

  {
    ...
    location: "Lavale Campus",
    district: "Pune",
    state: "Maharashtra",
    type: "Private",
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA","MBA Innovation & Entrepreneurship","Executive MBA"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 95000
    ...
    cutoff_sc: 88,
    cutoff_st: 82,
    avg_package_lpa: 26.77,
    max_package_lpa: 35.05,
    seats: 180,
    nirf_rank: 17,
...

  {
    ...
    level: "Both",
    naac_grade: "A++",
    courses: ["BBA","MBA","MBA HR","Executive MBA"],
    fees_structure: {
      ug_annual: 325000,
      ug_total: 975000,
      hostel_annual: 120000
...

  {
    ...
    location: "Kancheepuram Road",
    district: "Kancheepuram",
    state: "Tamil Nadu",
    type: "Private",
    level: "PG",
    naac_grade: "A+",
    courses: ["PGPM (1 Year)","PGDM (2 Year)"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 90000
...

  {
    ...
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA","MBA Banking & Financial Services","MBA HR"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 85000
    ...
    cutoff_sc: 75,
    cutoff_st: 70,
    avg_package_lpa: 14.6,
    max_package_lpa: 22.3,
    seats: 420,
    nirf_rank: 42,
...

  {
    ...
    level: "PG",
    naac_grade: "A++",
    courses: ["MBA Business Management","MBA Human Resource","Executive MBA"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 85000
    ...
    max_package_lpa: 71.5,
    seats: 360,
    nirf_rank: 35,
    website: "https://www.xub.edu.in"
  },

  {
    ...
    level: "PG",
    naac_grade: "A+",
    courses: ["PGDM Full Time","PGDM Part Time","Executive PGDM"],
    fees_structure: {
      ug_annual: 0,
      ug_total: 0,
      hostel_annual: 75000
    ...
    cutoff_sc: 78,
    cutoff_st: 72,
    avg_package_lpa: 11.6,
    max_package_lpa: 20.5,
    seats: 120,
    nirf_rank: 50,
...

  {
    ...
    location: "Lawley Road",
    district: "Coimbatore",
    state: "Tamil Nadu",
    type: "Government",
    level: "Both",
    naac_grade: "A++",
    courses: ["B.Sc Agriculture","B.Tech Agricultural Engineering","M.Sc Horticulture"],
    fees_structure: {
      ug_annual: 48000,
      ug_total: 192000,
      hostel_annual: 24000
    },
    cutoff_general: 185.5,
    cutoff_obc: 180,
    cutoff_sc: 165,
    cutoff_st: 155,
    avg_package_lpa: 4.8,
  ...
  {
    id: 10314,
    name: "University of Agricultural Sciences (UAS) Bangalore",
    location: "GKVK Campus",
    district: "Bengaluru Urban",
    state: "Karnataka",
    type: "Government",
    level: "Both",
    naac_grade: "A+",
    courses: ["B.Sc Agriculture","B.Sc Sericulture","M.Sc Agronomy"],
    fees_structure: {
      ug_annual: 42000,
      ug_total: 168000,
      hostel_annual: 22000
...

  {
    ...
    level: "Both",
    naac_grade: "A++",
    courses: ["B.Sc Agriculture","B.Tech Food Technology","M.Sc Entomology"],
    fees_structure: {
      ug_annual: 65000,
      ug_total: 260000,
      hostel_annual: 28000
...

  {
    ...
    level: "Both",
    naac_grade: "A+",
    courses: ["B.Sc Agriculture (Hons)","B.Sc Community Science","M.Sc Plant Pathology"],
    fees_structure: {
      ug_annual: 38000,
      ug_total: 152000,
      hostel_annual: 18000
...

  {
    ...
    level: "Both",
    naac_grade: "A",
    courses: ["B.Sc Agriculture","B.Tech Agricultural Engineering","M.Sc Soil Science"],
    fees_structure: {
      ug_annual: 44000,
      ug_total: 176000,
      hostel_annual: 20000
...

  {
    ...
    level: "Both",
    naac_grade: "A",
    courses: ["B.Sc Agriculture","B.Tech Food Technology","M.Sc Agronomy"],
    fees_structure: {
      ug_annual: 35000,
      ug_total: 140000,
      hostel_annual: 16000
...

  {
    ...
    level: "Both",
    naac_grade: "A",
    courses: ["B.Sc Agriculture","B.Tech Food Technology","M.Sc Seed Science"],
    fees_structure: {
      ug_annual: 38000,
      ug_total: 152000,
      hostel_annual: 18000
...

  {
    ...
    level: "Both",
    naac_grade: "A",
    courses: ["B.Sc Agriculture (Hons)","B.Sc Forestry","M.Sc Horticulture"],
    fees_structure: {
      ug_annual: 36000,
      ug_total: 144000,
      hostel_annual: 15000
...

  {
    ...
    level: "Both",
    naac_grade: "A",
    courses: ["B.Sc Agriculture","B.Sc Fisheries","M.Sc Agriculture"],
    fees_structure: {
      ug_annual: 38000,
      ug_total: 152000,
      hostel_annual: 16000
...

  {
    ...
    level: "Both",
    naac_grade: "A",
    courses: ["B.Sc Agriculture","B.Sc Food Technology","M.Sc Agronomy"],
    fees_structure: {
      ug_annual: 39000,
      ug_total: 156000,
      hostel_annual: 17000
...

  {
    ...
    level: "Both",
    naac_grade: "A+",
    courses: ["B.Sc Agriculture","B.Tech Dairy Technology","M.Sc Dairy Science"],
    fees_structure: {
      ug_annual: 45000,
      ug_total: 180000,
      hostel_annual: 20000
  ...
  {
    id: 10328,
    name: "Department of Architecture and Planning, IIT Roorkee",
    location: "Roorkee",
    district: "Dehradun",
    state: "Uttarakhand",
    type: "Government",
  ...
  {
    id: 10329,
    name: "Department of Architecture and Planning, NIT Calicut",
    location: "Chathamangalam",
    district: "Kozhikode",
    state: "Kerala",
    type: "Government",
    level: "Both",
    naac_grade: "A+",
    courses: ["B.Arch","M.Plan"],
    fees_structure: {
      ug_annual: 125000,
      ug_total: 625000,
      hostel_annual: 32000
  ...
  {
    id: 10330,
    name: "Department of Architecture and Planning, NIT Trichy",
    location: "Tanjore Road",
    district: "Tiruchirappalli",
    state: "Tamil Nadu",
    type: "Government",
    level: "Both",
  ...
  {
    id: 10331,
    name: "Department of Architecture, Jadavpur University",
    location: "Jadavpur",
    district: "Kolkata",
    state: "West Bengal",
    type: "Government",
  ...
  {
    id: 10332,
    name: "Department of Architecture, Anna University",
  ...
  {
    id: 10333,
    name: "Department of Architecture, BMS College of Engineering",
    location: "Basavanagudi",
    district: "Bengaluru Urban",
    state: "Karnataka",
    type: "Private",
...

  {
    ...
    level: "Both",
    naac_grade: "A++",
    courses: ["B.Arch","B.Des Interior Design","M.Arch","M.Des"],
    fees_structure: {
      ug_annual: 315000,
      ug_total: 1575000,
      hostel_annual: 95000
    ...
    seats: 160,
    nirf_rank: 15,
    website: "https://manipal.edu/msap.html"
  }
];
