...
export default function RegisterPage() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    background: '#f0eeff', color: '#1a1340',
  ...
  const labelStyle: React.CSSProperties = {
    ...
    color: '#534AB7', letterSpacing: '0.07em',
    ...
    <div style={{
        ...
        <div style={{
          ...
          <button onClick={handleGoogle} disabled={busy}
            style={{
              ...
              marginBottom:18,opacity:busy?0.7:1,
              transition:'all 0.2s ease',
            }}>
            ...
            Sign up with Google (instant — no OTP)
          </button>
          ...
          <form onSubmit={handleRegister}>
            ...
            <div style={{marginBottom:18}}>
              ...
              {confirm && password!==confirm && (
                <p style={{
                  fontSize:12,color:'#A32D2D',margin:'4px 0 0',
      ...
      <style>{`
        ...
        @media(max-width:768px){
          .auth-flex{flex-direction:column!important}
        }
      `}</style>
    </div>
  );
