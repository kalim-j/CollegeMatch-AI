...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 overflow-hidden flex items-center justify-center">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-0 left-1/4 w-96 h-96 rounded-full bg-purple-300/20 blur-[100px]"
          animate={{
            y: [0, 50, 0],
            x: [0, 30, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 rounded-full bg-blue-300/15 blur-[100px]"
          animate={{
            y: [0, -50, 0],
            x: [0, -30, 0],
          }}
      ...
      <div className="relative w-full max-w-md px-4 py-8">
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600">Sign in to continue your college journey</p>
          </motion.div>
          ...
          >
            <Link href="/" className="text-gray-505 text-sm hover:text-gray-700 transition flex items-center justify-center gap-1">
              ← Back to Home
            </Link>
          </motion.div>
        </motion.div>
